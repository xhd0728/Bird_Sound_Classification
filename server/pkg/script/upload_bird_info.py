...
url = "http://127.0.0.1:8000/api/v1/audio/info"
...
def get_wiki_by_file(file_path):
    with open(file_path, 'r', encoding="utf-8") as f:
        ...
        for line in wiki_list:
            ...
            print(detail_list)
            wiki_dict[detail_list[0]] = {
                "wiki_link": detail_list[1],
                "image_link": detail_list[2]
            }


if __name__ == "__main__":
    print(len(name_CN_list))
    print(len(name_EN_list))
    get_wiki_by_file("bird_wiki_data.txt")
    for i in range(47, len(name_CN_list)):
        try:
            data = {
                "name_CN": name_CN_list[i],
                "name_EN": name_EN_list[i],
                "wiki_link": wiki_dict.get(name_CN_list[i]).get("wiki_link"),
                "image_link": wiki_dict.get(name_CN_list[i]).get("image_link")
            }
